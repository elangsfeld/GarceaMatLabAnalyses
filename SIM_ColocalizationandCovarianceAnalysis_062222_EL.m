...
inDir = 'C:\Users\erla4195\Documents\Image files for analysis\*.nd2';
Folder = 'C:\Users\erla4195\Documents\Image files for analysis';

srcFiles = dir(inDir);%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
LPercentileThresh(1,1:4) = [99.95 99.75 99.75 99.75];
UPercentileThresh(1,1:4) = [100 100 100 100];
LStaticThresh(1,1:4) = [4000 2000 2000 1000];
