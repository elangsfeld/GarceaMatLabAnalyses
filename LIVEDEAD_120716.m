...
DAPI_inDir = 'D:\Work\Cell Proliferation after 24H ActD or TPL Treatment (12.07.16)\W1 - DAPI\*.tif'; %File path for DAPI images ('path\*.tif')
DAPI_Folder = 'D:\Work\Cell Proliferation after 24H ActD or TPL Treatment (12.07.16)\W1 - DAPI\'; % Folder path for DAPI images ('path\')

TAG_inDir = 'D:\Work\Cell Proliferation after 24H ActD or TPL Treatment (12.07.16)\W2 - PI\*.tif'; %File path for TAg images ('path\*.tif')
TAG_Folder = 'D:\Work\Cell Proliferation after 24H ActD or TPL Treatment (12.07.16)\W2 - PI\'; %Folder path for TAg images ('path\')
...
TAG_Threshold = 20000; %THRESHOLD VALUE FOR MEAN TAG INTENSITY TO INDICATE "POSITIVE" INFECTED STATUS.
%% 
...
figure('Position',[50 50 12000 700]) %[Left Bottom Width Height]
%% 
    ...
    DAPI01 = imread(DAPI_filename); %Calls the read image "DAPI01."
    ...
    DAPI_LowBound = 50; DAPI_UpperBound = 1000;
    ...
    DAPI_BW02 = imdilate(DAPI_BW02,strel('disk',2));
    DAPI_cc(i) = bwconncomp(DAPI_BW02,8); %Identifies connected components (cells) within the binary image
    ...
    TAG_background = imopen(TAG01,strel('disk',20));
